...
CREATE NONCLUSTERED INDEX IDX2_CATEGORIA
ON CATEGORIA (ID_SECCION);
...
CREATE NONCLUSTERED INDEX IDX_TIPO_COMBO
ON TIPO_COMBO (NOMBRE_TIPO_COMBO);
...
CREATE TABLE FACTURA(
    ...
    CONSTRAINT FK1_FACTURA FOREIGN KEY (ID_ORDEN, ID_SUCURSAL)
        REFERENCES ORDEN_CODIGO (ID_ORDEN, ID_SUCURSAL)
